...
function roll(die) {  // return a random number between min and max
...
// the problem locates in the syntax of case
  // when the result is 1 it will trigger both clauses in the block;
