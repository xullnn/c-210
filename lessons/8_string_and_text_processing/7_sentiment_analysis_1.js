...
function sentiment(text) {
  let textWords = text.split(/[^a-z]+/i);
  let positives = [];
  let negatives = [];
...
// split sentence by one or more non-alphabetical chars
// iterate through every word
  // check if positiveWords includes current word
    // if push that word into positives
  // check if negativeWords includes current word
    // similar
// evaluate the blance
